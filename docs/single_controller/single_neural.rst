...
.. doctest::
    ...
    >>> from idinn.sourcing_model import SingleSourcingModel
        ...
        >>> controller_neural.fit(sourcing_model=single_sourcing_model,sourcing_periods=50,epochs=2000,validation_sourcing_periods=1000,tensorboard_writer=SummaryWriter(comment="_single_1"),seed=1)
        >>> # Avg. cost near 10
