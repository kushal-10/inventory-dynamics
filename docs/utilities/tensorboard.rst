...
.. doctest::
    ...
    >>> import torch
        ...
        ... )
        >>> single_controller.fit(sourcing_model=single_sourcing_model,sourcing_periods=50,epochs=5000,validation_sourcing_periods=1000,tensorboard_writer=SummaryWriter(comment="_single_1"),seed=1)
        >>> from idinn.demand import UniformDemand
        >>> from idinn.single_controller.single_neural import SingleSourcingNeuralController
        >>> from torch.utils.tensorboard import SummaryWriter
